...
%global scl_devtoolset devtoolset-4
...
%if %runselftest
%global buildscls %{scl} %{scl_python} %{?scl_devtoolset}
%else
%global buildscls %{scl} %{?scl_devtoolset}
%endif
%endif
...
%{?scl_devtoolset:
BuildRequires:  %{scl_devtoolset}-toolchain
}
...
%changelog
* Thu Jul 21 2016 Marek Skalický <mskalick@redhat.com> - 3.0.11-2
- Use devtoolset-4 for building
- Fix dependencies for RHEL6

* Wed Apr 6 2016 Marek Skalicky <mskalick@redhat.com> - 3.0.11-1
- Upgrade to version 3.0.11 (RHBZ#1324379)
